...
class CNB_Select_Level_Panel : public vgui::EditablePanel
{
	DECLARE_CLASS_SIMPLE( CNB_Select_Level_Panel, vgui::EditablePanel );
public:
	CNB_Select_Level_Panel( vgui::Panel *parent, const char *name );
	virtual ~CNB_Select_Level_Panel();
